...
fn cross_platform_check() {
    ...
    static EXPECTED_HASHES: [[u8; 32]; 3] = [
        [34, 154, 209, 234, 32, 219, 206, 247, 204, 66, 115, 94, 55, 96, 22, 255, 181, 104, 171, 81,
         34, 29, 31, 25, 186, 72, 14, 90, 74, 165, 193, 81],
        [85, 46, 96, 82, 198, 161, 162, 98, 182, 194, 192, 179, 148, 192, 131, 150, 44, 122, 144,
         195, 150, 119, 238, 155, 27, 46, 233, 254, 159, 194, 218, 193],
        [162, 143, 116, 53, 30, 10, 178, 53, 209, 147, 70, 65, 207, 219, 74, 182, 50, 156, 35, 61,
         16, 249, 135, 15, 212, 107, 55, 29, 110, 146, 232, 254],
    ];
