...
fn cross_platform_check() {
    ...
    static EXPECTED_HASHES: [[u8; 32]; 3] = [
        [212, 86, 155, 78, 10, 150, 125, 81, 24, 140, 163, 204, 135, 109, 127, 181, 169, 80, 48,
         106, 60, 160, 109, 36, 237, 201, 209, 2, 223, 227, 125, 10],
        [104, 105, 215, 121, 125, 104, 86, 139, 156, 157, 23, 58, 61, 155, 41, 86, 30, 89, 203, 66,
         156, 66, 35, 197, 149, 102, 79, 12, 233, 56, 160, 61],
        [166, 135, 92, 224, 55, 214, 97, 194, 239, 233, 104, 46, 240, 34, 77, 234, 107, 185, 194,
         146, 149, 177, 98, 151, 147, 212, 166, 51, 250, 215, 92, 37]
    ];
